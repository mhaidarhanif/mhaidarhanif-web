...
globalCss({
  ...
  h2: { m: '$0', lineHeight: 'taller', fontSize: '1.5rem' },
  h3: { m: '$0', lineHeight: 'taller', fontSize: '1.25rem' },
  h4: { m: '$0', lineHeight: 'taller', fontSize: '1rem' },
  h5: { m: '$0', lineHeight: 'taller', fontSize: '1rem' },
